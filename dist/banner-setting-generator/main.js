...
module.exports = __webpack_require__(/*! /Users/obayashi_go/develop/banner-setting-generator/banner-setting-generator/src/main.ts */"zUnb");
...
class AppComponent {
    constructor() {
        this.title = 'banner-setting-generator';
    }
}
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | layout-layout-module */ "layout-layout-module").then(__webpack_require__.bind(null, /*! ./layout/layout.module */ "Tx//")).then(m => m.LayoutModule),
    },
];
